#ifndef GAME_MWMECHANICS_AIWAVE_H
#define GAME_MWMECHANICS_AIWAVE_H
...
namespace MWMechanics
{
	...
	**/
	class AiWave : public AiPackage
	{
	public:
		/// Follow Actor for duration or until you arrive at a world position
		AiWave(const std::string &ActorId, float duration, float X, float Y, float Z);
